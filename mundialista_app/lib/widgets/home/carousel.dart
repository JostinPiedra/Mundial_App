...
class CarruselEquipos extends StatefulWidget {
  const CarruselEquipos({Key? key}) : super(key: key);

  @override
  State<CarruselEquipos> createState() => _CarruselEquiposState();
}

class _CarruselEquiposState extends State<CarruselEquipos> {
  List<Widget> cards = [
    CardFb1(
        text: "Explore",
        imageUrl:
